...
class OpenAIClient:
    ...
    def extract_location(self, message):
        """從訊息中提取地點"""
        # 台灣常見城市和地區，按長度排序以優先匹配較長的地名
        locations = [
            '台北市', '新北市', '桃園市', '台中市', '台南市', '高雄市', '基隆市', '新竹市', '新竹縣',
            '苗栗縣', '彰化縣', '南投縣', '雲林縣', '嘉義市', '嘉義縣', '屏東縣', '宜蘭縣', 
            '花蓮縣', '台東縣', '澎湖縣', '金門縣', '連江縣',
            '台北', '新北', '桃園', '台中', '台南', '高雄', '基隆', '新竹', '苗栗',
            '彰化', '南投', '雲林', '嘉義', '屏東', '宜蘭', '花蓮', '台東', '澎湖',
            '金門', '馬祖', '中壢', '板橋', '三重', '中和', '永和', '新店', '汐止',
            '淡水', '林口', '八德', '龜山', '蘆竹', '大溪', '平鎮', '楊梅', '觀音',
            '新屋', '龍潭', '大園', '復興', '竹北', '竹東', '湖口', '新豐', '關西',
            '芎林', '寶山', '北埔', '峨眉', '橫山', '五峰', '尖石'
        ]
